...
$sharing_video_for_english_page            = get_field('sharing_video_for_english_page');
    ...
    <div class="cc-header__container">
        ...
        <div class="cc-header__container-item
            ...
            <section class="cc-share-tooltip" panel-id="share-tooltip">
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://youtu.be/<?php echo $intro_video_id?>"
                   target="_blank"
            ...
            <li class="cc-social__elem">
                <a class="cc-social__link"
                   target="_blank"
                    <?php
                    if ($language ==="EN") { ?>
                        href="https://www.facebook.com/sharer/sharer.php?u=https://business.facebook.com/SodaStream/videos/<?php  echo $sharing_video_for_english_page ?>"
                        <?php
                    } else { ?>
                        href="https://www.facebook.com/sharer/sharer.php?u=https://youtu.be/<?php  echo $intro_video_id ?>"
                        <?php
                    }
                    ?>
                >
